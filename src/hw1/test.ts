...
//  */
// interface Iopts {
//   decimal: number, errorOnInvalid: boolean, precision: number
// }

// type value = number|string;
// function currency(this: object, value: value, opts: Iopts) {
//   let that = this;
...
// function parse(value: value, opts: { symbol: string; separator: string; decimal: string; formatWithSymbol: boolean; errorOnInvalid: boolean; precision: number; pattern: string; negativePattern: string; } & Iopts, useRounding = true) {
//   let v = 0
